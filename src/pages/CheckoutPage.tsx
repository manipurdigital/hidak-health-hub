  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const orderData: any = {
        ...
        patient_name: shippingAddress.full_name,
        patient_phone: shippingAddress.phone,
        patient_location_lat: shippingAddress.latitude || null,
        patient_location_lng: shippingAddress.longitude || null,
        notes: notes || null,
        status: 'pending',
