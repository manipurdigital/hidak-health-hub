...
-- 2) RPCs expected by the app
-- Helper: safely get point from lat/lng
-- Note: PostgREST matches functions by argument names; we implement the exact names used by the app
...
BEGIN
  ...
  LEFT JOIN public.diagnostic_centers dc ON dc.id = g.center_id
...
-- Minimal implementation to unblock UI: return first matching geofence and a benign fee
