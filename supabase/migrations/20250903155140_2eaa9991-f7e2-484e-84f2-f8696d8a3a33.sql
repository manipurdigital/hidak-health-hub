-- Fix calc_distance_fee_from_geofence function signature and create base location functions
-- First drop the existing function to fix signature conflict
...
-- Recreation with corrected return type
...
-- Fix create_base_location to take individual parameters
...
-- Fix update_base_location to take individual parameters
