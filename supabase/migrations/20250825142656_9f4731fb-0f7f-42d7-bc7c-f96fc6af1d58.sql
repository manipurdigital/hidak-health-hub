-- Update export_schema_sql to skip aggregates and window functions (PostGIS etc.)
...
begin
  ...
  -- Functions and procedures (exclude this export function itself; skip aggregates/window functions)
  for rec in
